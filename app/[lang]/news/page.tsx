    ...
    <section className="max-w-[1240px] mx-auto px-5 md:px-10 pt-2 pb-20 md:pb-28">
      <header className="mb-10 md:mb-14 max-w-[680px]">
        ...
        <a
          ...
          className="mt-4 inline-block text-[13px] tracking-[0.15em] lowercase text-zinc-900 hover:text-zinc-500 transition-colors border-b border-zinc-300 pb-0.5"
        >
      ...
      {lightWidgetId ? (
        ...
        <div className="aspect-[4/3] sm:aspect-[16/9] w-full bg-zinc-50 flex items-center justify-center text-center px-6">
          <p className="text-[13px] tracking-[0.15em] uppercase text-zinc-400 max-w-[400px]">
            {lang === "ko"
