...
export function LeftSidebar({
  ...
  return (
    <aside className="hidden md:flex flex-col w-[200px] flex-shrink-0 px-8 lg:px-10 pt-12 lg:pt-14 pb-8 sticky top-0 self-start">
      <Link
        href={`/${lang}`}
      ...
      <a
        ...
        className="mt-4 inline-block text-zinc-700 hover:text-black transition-colors w-fit"
      >
        <svg
